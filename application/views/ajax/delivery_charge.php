<div class="ajax_result_address">
	...
	<h4 class="text-center">Deliver Options</h4><hr>
 	...
 	<ul class="list-unstyled">
 		...
 		<li><label>Delivery Charge</label><span class="pull-right">Rs. <?php echo $pincode_values->delivery_charge;?> </span></li>
	...
	<ul class="list-unstyled">
     	 ...
     	 <?php if($discount=$this -> session -> userdata('discount_amount')): ?>
        <li><label class="bold">Total</label><span class="pull-right">Rs.<?php echo round($this->cart->total()) - $discount + $pincode_values->delivery_charge;?>/-</span></li>
       <?php else : ?>
        <li><label class="bold">Total</label><span class="pull-right">Rs.<?php echo round($this->cart->total())+ $pincode_values->delivery_charge ;?>/-</span></li>
      <?php endif; ?> 
    </ul>
