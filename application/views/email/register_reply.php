   ...
   <body style="background:#e2e2e2;">
	  ...
	  <header>
	   <div style="width:255px;float:left;">
               <img style="width:150px;height:67px;" src="<?php echo base_url(IMAGES); ?>/logo_2b.png"/>
            </div>
	...
	<!--second-->
	<p>Dear Customer, 
    <p>Thank you for registering with Rice Rendezvous. <br></p>
	...
	<!--third step-->
	 ...
	 <!--fourth step end-->	
	  <div style="border-bottom:1px solid #e2e2e2;clear:both;padding-top:20px;"></div>
         <p style="color:#1492de;margin-bottom:0px;text-align:center;">Copyright <?php echo date('Y'); ?> &copy; Rice Rendezvous</p>
      </div>
